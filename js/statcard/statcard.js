function Statcard()
{
	...
	this.drawColoredArea3 = function( )
	{
		...
		fctx.clearRect(0,0,this.layout.dimensions.wdt,this.layout.dimensions.hgt);
		bctx.clearRect(0,0,this.layout.dimensions.wdt,this.layout.dimensions.hgt);
		this.drawImage(document.getElementById("statcard_front_color_area3").getContext("2d"), "brick_front.png", moc.color3);
		this.drawImage(document.getElementById("statcard_back_color_area3").getContext("2d"), "brick_back.png", moc.color3);
	};
	...
	this.drawForegroundFront = function ()
	{
		...
		this.drawWhiteTitleText(ctx, moc.cost, p.cost.size, p.cost.x, p.cost.y, p.cost.wdt, this.layout.serif);
		
		// Cost Title
		ctx.textAlign = "center";
		this.drawWhiteTitleText(ctx, "COST", p.costTitle.size, p.costTitle.x, p.costTitle.y, p.costTitle.wdt, this.layout.sansSerif);
	...
	this.buildSpecialitiesInfo = function() // ordered by importance
	{
		var result = [];
